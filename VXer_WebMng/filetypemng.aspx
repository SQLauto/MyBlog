<%@ Page Language="C#" AutoEventWireup="true" CodeFile="filetypemng.aspx.cs" Inherits="VXer_WebMng_filetypemng" %>
...
<body>
    ...
    <div style="text-align: left; width: 500px;">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grdFileTypes" runat="server" AutoGenerateColumns="False" BackColor="White"
                        BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                        CellPadding="3" ForeColor="Black"
                        GridLines="Vertical" DataKeyNames="id" 
                        onrowcancelingedit="grdFileTypes_RowCancelingEdit" 
                        onrowdeleting="grdFileTypes_RowDeleting" onrowediting="grdFileTypes_RowEditing" 
                        onrowupdating="grdFileTypes_RowUpdating">
