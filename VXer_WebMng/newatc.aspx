<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newatc.aspx.cs" Inherits="VXer_WebMng_newatc"
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    <asp:DropDownList ID="droplstAtcType" runat="server" Width="150px">
                    </asp:DropDownList>
                </td>
                <td style="text-align: left">
                    <asp:Button ID="btnSave" runat="server" Height="20px" Width="35px" Text="保存" Style="margin-left: 0px"
