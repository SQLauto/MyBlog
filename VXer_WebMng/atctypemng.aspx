<%@ Page Language="C#" AutoEventWireup="true" CodeFile="atctypemng.aspx.cs" Inherits="VXer_WebMng_atctypemng" %>
...
<body>
    ...
    <div style="text-align: left; width: 500px;">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grdAtcTypes" runat="server" AutoGenerateColumns="False" BackColor="White"
                        BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                        CellPadding="3" ForeColor="Black"
                        GridLines="Vertical" DataKeyNames="id" OnRowCancelingEdit="grdAtcTypes_RowCancelingEdit"
                        OnRowDeleting="grdAtcTypes_RowDeleting" OnRowEditing="grdAtcTypes_RowEditing"
                        OnRowUpdating="grdAtcTypes_RowUpdating" AllowPaging="True" 
                        onpageindexchanging="grdAtcTypes_PageIndexChanging" PageSize="7">
                        <FooterStyle BackColor="#CCCCCC" />
                        <Columns>
                            <asp:BoundField HeaderText="类型名称" DataField="articleType">
